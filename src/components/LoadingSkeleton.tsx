...
export function ProductCardSkeleton() {
  return (
    <div className="border border-[var(--color-border)] rounded-lg p-4 animate-pulse">
      <div className="flex justify-between items-start mb-3">
        ...
        <div className="h-6 bg-[var(--color-border)] rounded-full w-16"></div>
      </div>
      
      <div className="mb-3">
        <div className="h-6 bg-[var(--color-border)] rounded w-20 mb-2"></div>
      ...
      <div className="space-y-2 mb-3">
        <div className="flex justify-between">
          ...
          <div className="h-3 bg-[var(--color-border)] rounded w-12"></div>
        </div>
        <div className="flex justify-between">
      ...
      <div className="border-t pt-3">
        <div className="flex flex-col items-center">
          <div className="h-5 bg-[var(--color-border)] rounded w-16 mb-1"></div>
          <div className="h-3 bg-[var(--color-border)] rounded w-20 mb-2"></div>
          <div className="h-2 bg-[var(--color-border)] rounded w-full"></div>
        </div>
      </div>
    </div>
  );
